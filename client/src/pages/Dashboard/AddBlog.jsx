  ...
  return (
    <div className="lg:m-0 m-4">
      ...
      <form
        ...
        className="flex-1 p-4 space-y-6 overflow-auto lg:w-[800px] w-full shadow mt-2 rounded"
      >
        <div>
        ...
        <div className="flex flex-col space-y-2">
          <label className="text-lg font-medium text-gray-700">Excerpt</label>
          <textarea
            id="excerpt"
            className="w-full border rounded-md p-2"
            rows="4"
        ...
        <div className="flex flex-col space-y-2 relative h-74">
          ...
          <div
            ref={editorRef}
            className="border rounded-md min-h-[200px]"
          ></div>
          <Button
            type="button"
